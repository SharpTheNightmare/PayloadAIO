...
namespace librpc
{
    public class PS4RPC
    {
        ...
        private static readonly int RPC_PORT = 733;
        private static readonly uint RPC_PACKET_MAGIC = 0xBDAABBCC;
        private static readonly int RPC_MAX_DATA_LEN = 8192;
        ...
        /** packet sizes **/
        private static readonly int RPC_PACKET_SIZE = 12;
        private static readonly int RPC_PROC_READ_SIZE = 16;
        private static readonly int RPC_PROC_WRITE_SIZE = 16;
        private static readonly int RPC_PROC_LIST_SIZE = 36;
        private static readonly int RPC_PROC_INFO1_SIZE = 4;
        private static readonly int RPC_PROC_INFO2_SIZE = 60;
        private static readonly int RPC_PROC_INSTALL1_SIZE = 4;
        private static readonly int RPC_PROC_INSTALL2_SIZE = 12;
        private static readonly int RPC_PROC_CALL1_SIZE = 68;
        private static readonly int RPC_PROC_CALL2_SIZE = 12;
        private static readonly int RPC_PROC_ELF_SIZE = 8;
        private static readonly int RPC_KERN_BASE_SIZE = 8;
        private static readonly int RPC_KERN_READ_SIZE = 12;
        private static readonly int RPC_KERN_WRITE_SIZE = 12;
        ...
        /** messages **/
        private static readonly Dictionary<RPC_STATUS, string> StatusMessages = new Dictionary<RPC_STATUS, string>()
        {
